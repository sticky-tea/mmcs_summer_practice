...
typedef struct {
    ...
    XGost_encrypt_sr_uio_map maps[ MAX_UIO_MAPS ];
} XGost_encrypt_sr_uio_info;

/***************** Variable Definitions **************************************/
static XGost_encrypt_sr_uio_info uio_info;
...
static int uio_info_read_name(XGost_encrypt_sr_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/name", info->uio_num);
    return line_from_file(file, info->name);
}

static int uio_info_read_version(XGost_encrypt_sr_uio_info* info) {
    char file[ MAX_UIO_PATH_SIZE ];
    sprintf(file, "/sys/class/uio/uio%d/version", info->uio_num);
    return line_from_file(file, info->version);
}

static int uio_info_read_map_addr(XGost_encrypt_sr_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
static int uio_info_read_map_size(XGost_encrypt_sr_uio_info* info, int n) {
    int ret;
    char file[ MAX_UIO_PATH_SIZE ];
...
int XGost_encrypt_sr_Initialize(XGost_encrypt_sr *InstancePtr, const char* InstanceName) {
	XGost_encrypt_sr_uio_info *InfoPtr = &uio_info;
