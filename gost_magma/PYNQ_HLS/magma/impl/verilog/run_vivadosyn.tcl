...
set ip_vlnv xilinx.com:hls:GOST_Encrypt_SR:1.0
set ip_repo_path ../ip
...
dict set report_options hls_project gost_magma
dict set report_options hls_solution magma
...
dict set report_options bindmodules {GOST_Encrypt_SR_GOST_Crypt_Step_GOST_Table GOST_Encrypt_SR_control_s_axi}
