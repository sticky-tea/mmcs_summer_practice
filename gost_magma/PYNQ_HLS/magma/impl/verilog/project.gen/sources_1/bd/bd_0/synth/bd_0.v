...
module bd_0
  ...
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.DATA_I DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.DATA_I, LAYERED_METADATA undef" *) input [7:0]Data_i;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.DATA_O DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.DATA_O, LAYERED_METADATA undef" *) output [7:0]Data_o;
  output Data_o_ap_vld;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.DATA_OUT DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.DATA_OUT, LAYERED_METADATA undef" *) output [7:0]Data_out;
  output Data_out_ap_vld;
  (* X_INTERFACE_INFO = "xilinx.com:signal:data:1.0 DATA.MODE DATA" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME DATA.MODE, LAYERED_METADATA undef" *) input Mode;
  ...
  wire ap_clk_0_1;
  wire ap_rst_n_0_1;
  wire [7:0]hls_inst_Data_o;
  wire hls_inst_Data_o_ap_vld;
  wire [7:0]hls_inst_Data_out;
  wire hls_inst_Data_out_ap_vld;
  ...
  assign Data_i_0_1 = Data_i[7:0];
  assign Data_o[7:0] = hls_inst_Data_o;
  assign Data_o_ap_vld = hls_inst_Data_o_ap_vld;
  assign Data_out[7:0] = hls_inst_Data_out;
  assign Data_out_ap_vld = hls_inst_Data_out_ap_vld;
  assign Mode_0_1 = Mode;
  ...
  bd_0_hls_inst_0 hls_inst
       (.Data_i(Data_i_0_1),
        .Data_o(hls_inst_Data_o),
        .Data_o_ap_vld(hls_inst_Data_o_ap_vld),
        .Data_out(hls_inst_Data_out),
        .Data_out_ap_vld(hls_inst_Data_out_ap_vld),
        .Mode(Mode_0_1),
        .ap_clk(ap_clk_0_1),
