...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set Data_i [ create_bd_port -dir I -from 7 -to 0 -type data Data_i ]
  set Data_o [ create_bd_port -dir O -from 7 -to 0 -type data Data_o ]
  set Data_o_ap_vld [ create_bd_port -dir O Data_o_ap_vld ]
  set Data_out [ create_bd_port -dir O -from 7 -to 0 -type data Data_out ]
  set Data_out_ap_vld [ create_bd_port -dir O Data_out_ap_vld ]
  set Mode [ create_bd_port -dir I -type data Mode ]
  ...
  set hls_inst [ create_bd_cell -type ip -vlnv xilinx.com:hls:GOST_Encrypt_SR:1.0 hls_inst ]
  ...
  connect_bd_net -net Data_i_0_1 [get_bd_ports Data_i] [get_bd_pins hls_inst/Data_i]
  connect_bd_net -net Mode_0_1 [get_bd_ports Mode] [get_bd_pins hls_inst/Mode]
  ...
  connect_bd_net -net hls_inst_Data_o [get_bd_ports Data_o] [get_bd_pins hls_inst/Data_o]
  connect_bd_net -net hls_inst_Data_o_ap_vld [get_bd_ports Data_o_ap_vld] [get_bd_pins hls_inst/Data_o_ap_vld]
  connect_bd_net -net hls_inst_Data_out [get_bd_ports Data_out] [get_bd_pins hls_inst/Data_out]
  connect_bd_net -net hls_inst_Data_out_ap_vld [get_bd_ports Data_out_ap_vld] [get_bd_pins hls_inst/Data_out_ap_vld]
