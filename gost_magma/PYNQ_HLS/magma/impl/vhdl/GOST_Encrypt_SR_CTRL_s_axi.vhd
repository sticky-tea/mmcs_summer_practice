...
entity GOST_Encrypt_SR_CTRL_s_axi is
generic (
...
end entity GOST_Encrypt_SR_CTRL_s_axi;
...
-- 0x14 : reserved
-- 0x18 : Data signal of Mode
--        bit 0  - Mode[0] (Read/Write)
--        others - reserved
-- 0x1c : reserved
-- (SC = Self Clear, COR = Clear on Read, TOW = Toggle on Write, COH = Clear on Handshake)

architecture behave of GOST_Encrypt_SR_CTRL_s_axi is
    ...
    constant ADDR_MODE_DATA_0 : INTEGER := 16#18#;
    constant ADDR_MODE_CTRL   : INTEGER := 16#1c#;
